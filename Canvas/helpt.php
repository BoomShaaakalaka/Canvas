                  ...
                  <div class="table-responsive">
                    ...
                    <table width=100%, border="1"> 
                        <tr>
                            ...
                            <a href="guidet.php?ID=<?php echo $cid?>&SID=<?php echo $SID?>">Guidance</a>
                            </td>
                        </tr>
                        <tr>
                            <td height="50" colspan="3">
                            <a href="problemst.php?ID=<?php echo $cid?>&SID=<?php echo $SID?>">Problems</a>
                            </td>
                ...
                <div class="card-body">
                  <div class="table-responsive">
                    ...
                    <table width=100%, border="1"> 
                        <tr>
                            <td height="50" colspan="3">
                            <a href="contactt.php?ID=<?php echo $cid?>&SID=<?php echo $SID?>">If you have other problems, please click here!</a>
                            </td>
                        </tr>
