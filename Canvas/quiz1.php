...
<table >
<tr><td><textarea name='textf' class='inputtext' cols='70' rows='6'></textarea></td></tr>
<tr><td><input type='submit' name='do_hf' value='submit'></td>
    <td><li><a href="grades.php?ID=<?php echo $cid?>&SID=<?php echo $SID?>">return</a></li></td></tr>
    <?php
    
if(!empty($_POST['do_hf']))//当'回复'按钮触发执行
{
$bbs_hfnr=trim($_POST['textf']);//得到多行文本框
$sql="INSERT INTO quiz1 (SID, CID, answer) VALUES('{$SID}', '{$cid}','{$bbs_hfnr}')";
