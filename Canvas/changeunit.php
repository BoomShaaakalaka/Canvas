...
<?php
             $select = array( 'ID' => $cid,'week'=> $_GET['XID']);
                    $result = select("week", $select);
                 
            
            ?>
            
			<form class="contact100-form validate-form" action="uploadHandle.php?ID=<?php echo $cid?>&SID=<?php echo $SID?>&flabel=<?php echo $result[0]['filelabel'];?>&XID=<?php echo $_GET['XID'];?>"method="post" enctype="multipart/form-data" >
				
                <div class="wrap-input100 validate-input" data-validate="Name is required">
					<span class="label-input100">ModuleName：</span>
					<input class="input100" type="text" name="name" value="<?php echo $result[0]['name'];?>">
					<span class="focus-input100"></span>
				</div>

				<div class="wrap-input100 validate-input" data-validate = "Valid email is required: ex@abc.xyz">
					<span class="label-input100">StartDay：</span>
					<input class="input100" type="text" name="startday" value="<?php echo $result[0]['startday'];?>">
					<span class="focus-input100"></span>
				</div>

				<div class="wrap-input100 validate-input" data-validate="Phone is required">
					<span class="label-input100">EndDay：</span>
					<input class="input100" type="text" name="endday" value="<?php echo $result[0]['endday'];?>">
					<span class="focus-input100"></span>
				</div>
                
                <div class="wrap-input100 validate-input" data-validate="Phone is required">
					<span class="label-input100">StartTime：</span>
					<input class="input100" type="text" name="starttime" value="<?php echo $result[0]['starttime'];?>">
					<span class="focus-input100"></span>
				</div>
                
                <div class="wrap-input100 validate-input" data-validate="Phone is required">
					<span class="label-input100">EndTime：</span>
					<input class="input100" type="text" name="endtime" value="<?php echo $result[0]['endtime'];?>">
					<span class="focus-input100"></span>
				</div>
                
                <div class="wrap-input100 validate-input" data-validate="Phone is required">
					<span class="label-input100">UploadFiles：</span>
					<input class="input100" type="file" name="file1" value="Choose">
					<span class="focus-input100"></span>
				</div>
                
                <div class="wrap-input100 validate-input" data-validate="Phone is required">
					<span class="label-input100">DeleteFiles：</span>
                    <?php
                    
                        $select2 = array( 'ID' => $cid,'label'=>$result[0]['filelabel']);
                        $result2 = select("file", $select2);
                        $num=count($result2);
                        for($x=0;$x<$num;$x++){
                    ?>
                    <p><input type="checkbox" name="checkbox[]" value="<?php echo $x;?>" /> <?php   echo $result2[$x]['route']; ?></p>
                    <?php }
                    ?>
					<span class="focus-input100"></span>
				</div>
