...
<body>
      ...
      <div class="side-navbar-wrapper">
        ...
        <div class="main-menu">
          ...
          <ul id="side-main-menu" class="side-menu list-unstyled">                  
            ...
            <li><a href="connect.php?SID=<?php echo $ID?>&ID=<?php echo  $CID?>"> <i class="icon-rss-feed"></i>Connect                          </a></li>
          </ul>
        </div>
      </div>
    </nav>
	...
	<div class="container-contact100">
		...
		<div class="wrap-contact100">
            ...
            <form class="contact100-form validate-form" action="usernamechuli.php?ID=<?php echo $ID?>&sid=<?php echo $sid?>" enctype="multipart/form-data" method="post">
				...
				<div class="wrap-input100 validate-input" data-validate="Phone is required">
                    ...
                    <input class="input100" type="text" name="phone" value="<?php echo $sid;?>" readonly>
					<span class="focus-input100"></span>
				</div>
