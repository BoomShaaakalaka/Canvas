      ...
      <div class="side-navbar-wrapper">
        ...
        <div class="main-menu">
          ...
          <ul id="side-main-menu" class="side-menu list-unstyled">                  
            ...
            <li ><a href="help_admin.php?ID=<?php echo $ID?>"> <i class="icon-search"></i>Help                             </a></li>
            <li><a href="connect.php?ID=<?php echo $ID?>"> <i class="icon-rss-feed"></i>Connect                          </a></li>
          </ul>
        </div>
      </div>
    </nav>
                        ...
                        <tr>
                          ...
                          <td><?php echo $v['ID']?></td>
                            ...
                            <td>
                              <?php echo $v['email'];?></td>
                            <td>
                                <form action="xiugaichuli_admin.php?email=<?php echo $v['email']?>&name=<?php echo $v['name']?>&ID=<?php echo $v['ID']?>&password=<?php echo $v['password']?>" method="post">                            
                                <input type="submit" value="修改"><!--评论显示的地方--><!--单击评论提交内容进处理页面-->
                                </form>
                                <form action="shanchuchuli_admin.php?ID=<?php echo $v['ID']?>" method="post">
