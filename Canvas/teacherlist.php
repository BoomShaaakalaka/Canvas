                        ...
                        <tr>
                          ...
                          <td><?php echo $v['TID']?></td>
                            ...
                            <td>
                              <?php echo $v['email'];?></td>
                            <td>
                                <form action="xiugaichuli.php?email=<?php echo $v['email']?>&name=<?php echo $v['name']?>&TID=<?php echo $v['TID']?>&password=<?php echo $v['password']?>" method="post">                            
                                <input type="submit" value="修改"><!--评论显示的地方--><!--单击评论提交内容进处理页面-->
                                </form>
                                <form action="shanchuchuli.php?TID=<?php echo $v['TID']?>" method="post">
