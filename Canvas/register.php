      ...
      <div class="container">
        <div class="form-outer text-center d-flex align-items-center">
          <div class="form-inner">
            <div class="logo text-uppercase"><span>User</span><strong class="text-primary">Signup</strong></div>
            <p>Please add your information!</p>
            <form action="registerTo.php" method="POST" enctype="multipart/form-data">
              ...
              <!--<div class="form-group text-center">
                ...
                <div class="form-group text-center"><input type="submit" value="Sign Up" id="file" class="btn btn-primary"></div>
