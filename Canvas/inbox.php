      ...
      <div class="side-navbar-wrapper">
        ...
        <div class="main-menu">
         ...
         <ul id="side-main-menu" class="side-menu list-unstyled">                  
            ...
            <li><li class="active"> <a href="inbox.php?ID=<?php echo $cid?>&SID=<?php echo $SID?>"> <i class="icon-mail"></i>Inbox
                      ...
                      <!-- List-->
                        ...
                        <div class="feed d-flex justify-content-between">
                          <div class="feed-body d-flex justify-content-between"><a href="#" class="feed-profile"><img src="img/xinfeng.jpg" alt="person" class="img-fluid rounded-circle"></a>
                            <div class="content"><a href="message.php?ID='; echo $cid;echo'&SID=';echo $SID;echo'&XID='; echo $x;echo'"><strong>';
     ...
     <div class="col-lg-8">
        <div class="card" width=100%>
            <div class="card-header" align="right">
                <li><a href="inboxWrite.php?ID=<?php echo $cid?>&SID=<?php echo $SID?>"><i class="icon-ios-email">Write</i></a></li>
            </div>
            <div class="card-body" align="center" style="margin-top:100px;margin-bottom:40px">
               <a href="#" class="feed-profile" ><img src="img/inbox.jpg" class="img-fluid rounded-circle" ></a> 
                <div style="margin-bottom: 150px">
            <p class="font" align="middle">No Conversations Selected</p>
            </div>
            </div>s
