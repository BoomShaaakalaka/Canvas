...
<body>
	...
	<div class="container-contact100">
		...
		<div class="wrap-contact100">
            ...
            <form class="contact100-form validate-form" action="teacher_adminchuli.php?" enctype="multipart/form-data" method="post">
                <div class="wrap-input100 validate-input" data-validate="Phone is required">
					<span class="label-input100">教工号：</span>
                    
                    <input class="input100" type="text" name="TID" value="<?php echo $TID;?>" readonly>
