...
<body>
	...
	<div class="container-contact100">
		...
		<div class="wrap-contact100">
            ...
            <form class="contact100-form validate-form" action="usernamechuli_admin.php?ID=<?php echo $ID?>" enctype="multipart/form-data" method="post">
                <div class="wrap-input100 validate-input" data-validate="Phone is required">
					<span class="label-input100">学号：</span>
                    
                    <input class="input100" type="text" name="phone" value="<?php echo $ID;?>" readonly>
