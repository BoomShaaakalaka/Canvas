                  ...
                  <div class="table-responsive">
                    ...
                    <table width=100%, border="1"> 
                        <tr>
                            ...
                            <form action="pinglunchuli.php?SID=<?php echo $SID?>&ID=<?php echo $ID?>" method="post">
                                评论内容：
...
?>
    <div>
       <form action="delchuli.php?ID=<?php echo $ID?>&SID=<?php echo $SID?>&time=<?php echo $v[3]?>&id=<?php echo $v[0]?>" method="post"> <!--删除按钮-->
    ...
    <div>
       ...
       <form action="huifuchuli.php?ID=<?php echo $ID?>&time=<?php echo $v[3]?>&sid=<?php echo $SID?>&id=<?php echo $v[0]?>" method="post"> <!--回复按钮-->
