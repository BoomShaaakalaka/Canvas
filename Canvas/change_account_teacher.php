      ...
      <div class="side-navbar-wrapper">
        ...
        <div class="main-menu">
          ...
          <ul id="side-main-menu" class="side-menu list-unstyled">                  
            <li class="active"><a href="account_teacher.php?SID=<?php echo $SID?>&ID=<?php echo  $ID?>"> <i class="icon-user"></i>Account                             </a></li>
            ...
            <li><a href="#exampledropdownDropdown" aria-expanded="false" data-toggle="collapse"> <i class="icon-interface-windows"></i>Courses </a>
              <ul id="exampledropdownDropdown" class="collapse list-unstyled ">
                ...
                <li><a href="discussion_teacher.php?SID=<?php echo $ID?>&ID=<?php echo  $ID?>">Discussions</a></li>
...
<section>
		...
		<div class="wrap-contact100">
            ...
            <form class="contact100-form validate-form" action="usernamechuli_teacher.php?ID=<?php echo $ID?>&SID=<?php echo $SID?>" enctype="multipart/form-data" method="post">
