      ...
      <div class="side-navbar-wrapper">
        ...
        <div class="main-menu">
          ...
          <ul id="side-main-menu" class="side-menu list-unstyled">                  
            <li class="active"><a href="admin_account.php?ID=<?php echo $ID?>"> <i class="icon-user"></i>Account                             </a></li>
...
<?php
			...
			<form class="contact100-form validate-form" action="homeEditTo1.php?cid=<?php echo $cid;?>" method="post" enctype="multipart/form-data" >
				...
				<div class="wrap-input100 validate-input" data-validate = "Valid email is required: ex@abc.xyz">
					...
					<input class="input100" type="text" name="startday" value="<?php echo $result[0]['startdate'];?>">
					<span class="focus-input100"></span>
				</div>

				<div class="wrap-input100 validate-input" data-validate="Phone is required">
					<span class="label-input100">EndDay：</span>
					<input class="input100" type="text" name="endday" value="<?php echo $result[0]['enddate'];?>">
					<span class="focus-input100"></span>
				</div>
                
                <div class="wrap-input100 validate-input" data-validate="Phone is required">
					<span class="label-input100">TID：</span>
					<input class="input100" type="text" name="TID" value="<?php echo $result[0]['TID'];?>">
					<span class="focus-input100"></span>
				</div>
                
                <div class="wrap-input100 validate-input" data-validate="Phone is required">
					<span class="label-input100">week：</span>
					<input class="input100" type="text" name="week" value="<?php echo $result[0]['week'];?>">
					<span class="focus-input100"></span>
				</div>
