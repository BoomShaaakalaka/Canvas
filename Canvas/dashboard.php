...
$result = sql_query("select * from `stucour`");
$ID=$_REQUEST['SID'];
      ...
      <div class="side-navbar-wrapper">
        ...
        <div class="main-menu">
          ...
          <ul id="side-main-menu" class="side-menu list-unstyled">                  
            ...
            <li class="active"><a href="dashboard.php?SID=<?php echo $ID?>"> <i class="icon-form"></i>Dashboard                      </a></li>
        ...
        <div class="container-fluid">
          ...
          <div class="row">
            ...
            foreach( $result as $k=>$v){
              if($v['SID'] == $ID)
              {
                  $result1 = sql_query("select * from `course`");
            ...
            ?>
                         ...
                         <a href="home.php?ID=<?php echo isset($v1['ID'])?$v1['ID']:"";?>&SID=<?php echo $ID?>"><?php echo $v1['name'] ?></a>
                           </div>
                             <div class="card-body">
                    
                             <img src=<?php echo $v1['image']?> alt="person" class="img-fluid">
