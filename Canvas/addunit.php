      ...
      <div class="side-navbar-wrapper">
        ...
        <div class="main-menu">
          ...
          <ul id="side-main-menu" class="side-menu list-unstyled">                  
            ...
            <li><a href="contact.php?ID=<?php echo $cid?>&SID=<?php echo $SID?>"> <i class="icon-rss-feed"></i>Connect                          </a></li>
          </ul>
        </div>
      </div>
    </nav>
   <div class="page">
	...
	<div class="container-contact100">
		...
		<div class="wrap-contact100">
			...
			<form class="contact100-form validate-form" action="uploadHandler.php?ID=<?php echo $cid?>&SID=<?php echo $SID ?>&YID=1" method="post" enctype="multipart/form-data" >
				
                <div class="wrap-input100 validate-input" data-validate="Name is required">
					<span class="label-input100">ModuleNum：</span>
				...
				<div class="wrap-input100 validate-input" data-validate = "Valid email is required: ex@abc.xyz">
					...
					<input class="input100" type="text" name="startday" >
					<span class="focus-input100"></span>
				</div>

				<div class="wrap-input100 validate-input" data-validate="Phone is required">
					<span class="label-input100">EndDay：</span>
					<input class="input100" type="text" name="endday" >
					<span class="focus-input100"></span>
				</div>
                
                <div class="wrap-input100 validate-input" data-validate="Phone is required">
					<span class="label-input100">StartTime：</span>
					<input class="input100" type="text" name="starttime" >
					<span class="focus-input100"></span>
				</div>
                
                <div class="wrap-input100 validate-input" data-validate="Phone is required">
					<span class="label-input100">EndTime：</span>
					<input class="input100" type="text" name="endtime" >
					<span class="focus-input100"></span>
				</div>
