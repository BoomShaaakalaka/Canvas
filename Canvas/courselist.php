...
<body>
        ...
        <div class="main-menu">
          ...
          <ul id="side-main-menu" class="side-menu list-unstyled">                  
            ...
            <li><a href="#exampledropdownDropdown" aria-expanded="false" data-toggle="collapse"> <i class="icon-interface-windows"></i>User List </a>
              ...
              <li class="active"><a href="courselist.php?ID=<?php echo $ID?>"> <i class="fa fa-bar-chart"></i>Course List                    </a></li>
   ...
   $x=0;
            foreach( $result as $k=>$v){
             ...
             ?>      
             <form action="coursemodify.php?ID=<?php echo $x;?>" method="post" name="form1">
                        ...
                        <tr>
                          ...
                          <td><?php echo $v['name']?></td>
                            ...
                            <td><input type="submit" value="modify">
                              ...
                              <form action="deletecourse.php?ID=<?php echo $v['ID'];?>" method="post" name="form2">   
