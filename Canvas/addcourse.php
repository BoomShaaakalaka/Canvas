...
<body>
      ...
      <div class="side-navbar-wrapper">
        ...
        <div class="main-menu">
          ...
          <ul id="side-main-menu" class="side-menu list-unstyled">                  
            ...
            <li><a href="#exampledropdownDropdown" aria-expanded="false" data-toggle="collapse"> <i class="icon-interface-windows"></i>User List </a>
              <ul id="exampledropdownDropdown" class="collapse list-unstyled ">
                <li class="active"><a href="teacherlist.php?ID=<?php echo $ID?>">Teacher List</a></li>
            ...
            <li class="active"><a href="#exampledropdownDropdown1" aria-expanded="false" data-toggle="collapse"> <i class="icon-interface-windows"></i>Administration </a>
              <ul id="exampledropdownDropdown1" class="collapse list-unstyled ">
                <li class="active"><a href="addcourse.php?ID=<?php echo $ID?>">Add Course</a></li>
	...
	<div class="container-contact100">
		...
		<div class="wrap-contact100">
            ...
            <form class="contact100-form validate-form" action="addcoursechuli_admin.php?" enctype="multipart/form-data" method="post">
                <div class="wrap-input100 validate-input" data-validate="Phone is required">
					<span class="label-input100">课程ID号：</span>
                    
                    <input class="input100" type="text" name="ID">
					<span class="focus-input100"></span>
				</div>
				<div class="wrap-input100 validate-input" data-validate="Name is required">
					<span class="label-input100">课程名：</span>
                    <input class="input100" type="text" name="name">
					<span class="focus-input100"></span>
				</div>

				<div class="wrap-input100 validate-input" data-validate = "Valid email is required: ex@abc.xyz">
					<span class="label-input100">开始时间：</span>
					
                    <input class="input100" type="text" name="startdate">
					<span class="focus-input100"></span>
				</div>
                <div class="wrap-input100 validate-input" data-validate = "Valid email is required: ex@abc.xyz">
					<span class="label-input100">截止时间：</span>
					
                    <input class="input100" type="text" name="enddate">
					<span class="focus-input100"></span>
				</div>
				<div class="wrap-input100 validate-input" data-validate = "Valid email is required: ex@abc.xyz">
					<span class="label-input100">授课教师编号：</span>
					
                    <input class="input100" type="text" name="TID">
					<span class="focus-input100"></span>
				</div>
                <div class="wrap-input100 validate-input" data-validate = "Valid email is required: ex@abc.xyz">
					<span class="label-input100">上课周数：</span>
					
                    <input class="input100" type="text" name="week">
					<span class="focus-input100"></span>
				</div>
