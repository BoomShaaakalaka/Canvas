...
<body>
      ...
      <div class="side-navbar-wrapper">
        ...
        <div class="main-menu">
          ...
          <ul id="side-main-menu" class="side-menu list-unstyled">                  
            <li class="active"><a href="account.php?SID=<?php echo $ID?>&ID=<?php echo  $CID?>"> <i class="icon-user"></i>Account                             </a></li>
            <li><a href="dashboard.php?SID=<?php echo $ID?>"> <i class="icon-form"></i>Dashboard                      </a></li>
            <li><a href="#exampledropdownDropdown" aria-expanded="false" data-toggle="collapse"> <i class="icon-interface-windows"></i>Courses </a>
              <ul id="exampledropdownDropdown" class="collapse list-unstyled ">
                <li><a href="home.php?SID=<?php echo $ID?>&ID=<?php echo  $CID?>">Home</a></li>
                <li><a href="syllabus.php?SID=<?php echo $ID?>&ID=<?php echo  $CID?>">Syllabus</a></li>
                <li><a href="modules.php?SID=<?php echo $ID?>&ID=<?php echo  $CID?>">Modules</a></li>
                <li><a href="discussion.php?SID=<?php echo $ID?>&ID=<?php echo  $CID?>">Discussions</a></li>
                <li><a href="grades.php?SID=<?php echo $ID?>&ID=<?php echo  $CID?>">Grades</a></li>
                <li><a href="assignments.php?SID=<?php echo $ID?>&ID=<?php echo  $CID?>">Assignment</a></li>
              </ul>
            </li>
            <li><a href="calendar.php?SID=<?php echo $ID?>&ID=<?php echo  $CID?>"> <i class="fa fa-bar-chart"></i>Calendar                    </a></li>
            
            <!--<li><a href="login.html"> <i class="icon-interface-windows"></i>Login page                             </a></li>-->
            <li> <a href="inbox.php?SID=<?php echo $ID?>&ID=<?php echo  $CID?>"> <i class="icon-mail"></i>Inbox
                <div class="badge badge-warning">6 News</div></a></li>
            <li ><a href="help.php?SID=<?php echo $ID?>&ID=<?php echo  $CID?>"> <i class="icon-search"></i>Help                             </a></li>
            <li><a href="contact.php?SID=<?php echo $ID?>&ID=<?php echo  $CID?>"> <i class="icon-rss-feed"></i>Contact                          </a></li>
          </ul>
        </div>
      </div>
    </nav>
	...
	<div class="container-contact100">
		...
		<div class="wrap-contact100">
            ...
            <form class="contact100-form validate-form" action="change_account.php?ID=<?php echo $CID?>&sid=<?php echo $v['SID'];?>&name=<?php echo $v['name'];?>&password=<?php echo $v['password'];?>" method="post" name="form1">
				...
				<div class="wrap-input100 validate-input" data-validate="Phone is required">
					<span class="label-input100">学号：</span>
                    
                    <input class="input100" type="text" name="phone" value="<?php echo $v['SID'];?>" readonly>
					<span class="focus-input100"></span>
				</div>
