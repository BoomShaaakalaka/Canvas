...
<tr><td><input type='submit' name='do_hf' value='upload'></td>
    <td><li><a href="gradest.php?ID=<?php echo $cid?>&SID=<?php echo $SID?>">return</a></li></td></tr>
    <?php
    
if(!empty($_POST['do_hf']))//当'回复'按钮触发执行
{
$bbs_hfnr=trim($_POST['textf']);//得到多行文本框
$sql="insert into quiz0 (CID, question) values('{$cid}', '{$bbs_hfnr}')";
