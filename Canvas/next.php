      ...
      <div class="side-navbar-wrapper">
        ...
        <div class="main-menu">
          ...
          <ul id="side-main-menu" class="side-menu list-unstyled">                  
            ...
            <li class="active"><a href="" aria-expanded="false" data-toggle="collapse"> <i class="icon-interface-windows"></i>Courses </a>
...
$all = mysqli_num_rows($conn->query("select * from quiz"));
...
if($page == 5){
    ...
    echo "<div id='tiku'>";
        echo "<ul>";
            echo "<li><a href='next.php?ID=$cid&SID=$SID&page=$prepage'>上一题</a></li>";
            echo "<li><a href='next.php?ID=$cid&SID=$SID&page=$nextpage'>下一题</a></li>";
        echo "</ul>";
    echo "<div>";
    echo "<br/>";
    if ($page == $allpage + 1){
        $page1=$allpage;
        echo "<p class='fenye_tips'>共".$allpage."道题，当前是第".$page1."题</p>";
    }else{
        echo "<p class='fenye_tips'>共".$allpage."道题，当前是第".$page."题</p>";
    }
        
    if ($page == $allpage + 1){
        echo "<li><a href='grades.php?ID=$cid&SID=$SID&page=$prepage'>请返回后重新点击考试回答主观题</a></li>";
    }
    echo "<br/><br/>";
    echo "</div>";
    ?>
