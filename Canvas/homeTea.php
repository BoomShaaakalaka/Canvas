...
$select = array('ID' => $where['ID'], 'week' => $course[0]['week']);
        ...
        <nav class="navbar">
          <div class="container-fluid">
            <div class="navbar-holder d-flex align-items-center justify-content-between">
             ...
             <input type="button" onclick="window.location.href='homeTeaEdit.php?ID=<?php echo $where['ID'];?>&SID=<?php echo $SID?>'" value="Edit" class="btn btn-primary">
                <!-- Log out-->
